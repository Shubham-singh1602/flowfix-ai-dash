  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "traffic-green": "var(--shadow-traffic) hsl(var(--traffic-green))",
        "traffic-yellow": "var(--shadow-traffic) hsl(var(--traffic-yellow))",
        "traffic-red": "var(--shadow-traffic) hsl(var(--traffic-red))",
      },
      transitionDuration: {
      ...
      animation: {
        ...
        "traffic-blink": "traffic-blink 1s ease-in-out infinite",
        "slide-up": "slide-up 0.3s ease-out",
        "fade-in": "fade-in 0.5s ease-out",
        "bounce-in": "bounce-in 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)",
        "vehicle-move": "vehicle-move 8s linear infinite",
        "data-update": "data-update 0.3s ease-out",
      },
    },
  },
